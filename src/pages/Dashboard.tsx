          ...
          >
            ...
            <div className="relative">
              ...
              <div className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-4">
                ₹5,000 <span className="text-sm text-gray-400 font-normal line-through">₹10,000</span>
              </div>
              <p className="text-gray-300 text-sm">
                All premium features in one affordable package
              </p>
              <button className="mt-6 w-full py-3 px-4 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-medium rounded-lg transition-all">
                Enroll Now
              </button>
            </div>
          </motion.div>

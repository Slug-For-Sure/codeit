import { MoreVertical, Play, RotateCcw } from 'lucide-react'
...
export function ArchivedCourseCard({ course, onUnarchive }: ArchivedCourseCardProps) {
  return (
    <Card className="overflow-hidden">
          ...
          <div className="absolute top-2 right-2">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem onClick={() => onUnarchive(course._id)}>
                  Unarchive
                </DropdownMenuItem>
      ...
      <CardFooter className="p-4 pt-0">
        <Button className="w-full" onClick={() => onUnarchive(course._id)}>
